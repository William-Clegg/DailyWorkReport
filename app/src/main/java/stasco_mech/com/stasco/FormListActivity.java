 ...
 * lead to a {@link FormDetailActivity} representing
...
public class FormListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.form_detail_container) != null) {
        ...
        View recyclerView = findViewById(R.id.form_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final FormListActivity mParentActivity;
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    if(item.id.equals("2")) {
                        ...
                        intent.putExtra(FormDetailFragment.ARG_ITEM_ID, item.id);
                        ...
                        Context context = view.getContext();
                        Intent intent = new Intent(context, FormDetailActivity.class);
                        intent.putExtra(WorkFormDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(FormListActivity parent,
